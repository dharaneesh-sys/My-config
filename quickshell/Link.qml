...
/**
 * LINK surface: connectivity rows (Network, Bluetooth) with WLAN and
 * Bluetooth drill-in subviews that cross-fade in place. Owns the `subview`
 * state machine and exposes `desiredW`, and `back()` for the pill's morph
 * and Escape plumbing.
 */
PillSurface {
    id: root
